...
import cn.twopair.view.handler.WithdrawalHandler;
 ...
 * @Description TODO
 * @Author ljjtpcn
 * @Date 2022/5/26 下午7:34
 * @Version 1.0
 **/

@Getter
@Setter
public class WithdrawalView extends JDialog {
    //顶部组件
    ...
    public WithdrawalView(MainView mainView) {

        super(mainView, "取款业务", true);
        WithdrawalHandler withdrawalHandler = new WithdrawalHandler(this, mainView);
        ...
        BulkImportUtil.setFont(font, cardNumberText, moneyText, dateText, remarkText, sureButton, cancelButton, cardPasswordText);
        ...
        //设置监听
        sureButton.addActionListener(withdrawalHandler);
        cancelButton.addActionListener(withdrawalHandler);
